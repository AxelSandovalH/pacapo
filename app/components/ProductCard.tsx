...
function waProducto(nombre: string, opcion?: string) {
  const detalle = opcion ? ` (${opcion})` : ''
  return `${WPP_BASE}?text=${encodeURIComponent(
    `Hola Pácapo, me interesa el producto: *${nombre}${detalle}*. ¿Tienen disponibilidad y cuánto tiempo de anticipación necesitan?`
  )}`
}
    ...
    try {
      const res = await fetch('/api/checkout', {
        ...
        body: JSON.stringify({
          ...
          opcionNombre: selectedOpcion?.nombre ?? null,
          opcionPrecio: precioMostrar,
      ...
      <div className="producto-body">
        ...
        {hasOpciones ? (
          <div className="opciones-selector">
            <p className="opciones-label">Selecciona tamaño:</p>
        ...
        <div className="card-btns">
          ...
          <a
            href={waProducto(p.nombre, selectedOpcion?.nombre)}
            className="btn-pedir"
            target="_blank"
            rel="noopener"
          >
